...
function toggleButtons() {
  ...
  removeRowButton.style.display = rows <= 2;
  appendRowButton.style.display = rows >= 10;
  removeColumnButton.style.display = columns <= 2;
  appendColumnButton.style.display = columns >= 10;
}
